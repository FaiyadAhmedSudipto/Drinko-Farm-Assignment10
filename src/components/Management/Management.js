...
const Management = () => {
    ...
    useEffect(() => {
        fetch('https://calm-fjord-86946.herokuapp.com/items')
            .then(res => res.json())
    ...
    const deleteProduct = (id) => {
        ...
        fetch(`https://calm-fjord-86946.herokuapp.com/delete/${id}`, {
            method: 'DELETE'
        })
            .then(res => res.json())
            .then(result => {
    ...
    return (
        <div>
            ...
            <div className="managementPage">
                <h3>You have: {bookings.length} products in your store</h3>
